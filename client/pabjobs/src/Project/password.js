                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 my-5">
                            <div className="profile-item">
                                ...
                                <div className="button-items ">
                                    ...
                                    <button className="button-profile mt-2" onclick="changeBtn()">Change Password</button>
                        ...
                        <div className="col-lg-7 my-5">
                            <div className="info-item p-3">
                                <div className="py-3">
                                    <h4 className="basic-item">Change Password</h4>
                                </div>
                                <div className="py-2">
                                    <label for="name" className="py-1">Old Password</label>
                                    <input type="password" id="name" className="form-control inputfield-item" placeholder="Enter old Password" />
                                </div>
                                <div className="row my-4">
                                    <div className="col-lg-6">
                                        <label for="state" className="py-2">New Password</label>
                                        <div className="same-item">
                                            <input type="password" className="form-control " id="state" placeholder="Enter your new Password" />
                                        </div>

                                    </div>
                                    <div className="col-lg-6">
                                        <label for="state" className="py-2">Confirm Password</label>
                                        <div className="same-item">
                                            <input type="password" className="form-control" id="state" placeholder="Enter your Confirm Password" />
                                        </div>
                                    </div>
                                </div>

                                <div className="update-button my-4">
