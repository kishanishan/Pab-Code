      ...
      <div className="section ">
        ...
        <div className='container my-3'>
            <div className='row'>
                ...
                <div className='col-lg-2'>
                <button className="active-item col-lg-12 col-md-5 mt-2">Jobs By Category</button>
                </div>
                <div className='col-lg-2'>
        ...
        <div className='container my-4'>
            <div className='row'>
                ...
                <p className='browsejobs_item align-items-center align-self-center'>Top Companies By Categories</p>
                </div>
                <div className='col-lg-6'>
		...
		<div className='container my-4'>
			{
				Jobcategory.map((loc)=>
				<button className='button_location m-2'>{loc.JobCategory}</button>
				)
