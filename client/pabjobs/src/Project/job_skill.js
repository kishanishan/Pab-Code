      ...
      <div className="section ">
        ...
        <div className='container my-3'>
            <div className='row'>
                ...
                <div className='col-lg-2'>
                <button className="active-item  col-lg-12 col-md-5 mt-2">Jobs By Skills</button>
                </div>
            </div>
        </div>
        <div className='container my-4'>
            <div className='row'>
                ...
                <p className='browsejobs_item align-items-center align-self-center'>BROWSE JOBS BY SKILL</p>
                </div>
                <div className='col-lg-6'>
		...
		<div className='container my-4'>
			{
				JobSkill.map((loc)=>
				<button className='button_location m-2'>{loc.JobSkill}</button>
				)
