...
function Company() {
	const [Jobcompany, setjobcompny] = useState([]);

	const fetchApi = async (req, res) => {
		try {
			const token = localStorage.getItem('token');
			const response = await axios.get("http://localhost:3001/jobcompany", {
				headers: {
					token: `${token}`,
				},
			});
			setjobcompny(response.data);
      ...
      <div className="section ">
        ...
        <div className='container my-3'>
            <div className='row'>
                ...
                <div className='col-lg-2'>
                <button className=" active-item col-lg-12 col-md-5 mt-2">Jobs By Company</button>
                </div>
                <div className='col-lg-2'>
        ...
        <div className='container my-4'>
            <div className='row'>
                ...
                <p className='browsejobs_item align-items-center align-self-center'>Featured Jobs By Companies</p>
                </div>
                <div className='col-lg-6'>
		...
		<div className='container my-4'>
			{
				Jobcompany.map((loc)=>
				<button className='button_location m-2'>{loc.JobComapny}</button>
				)
